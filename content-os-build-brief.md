...
| Layer | Choice | Notes |
|---|---|---|
| Framework | Next.js (App Router) | React framework. Allows for secure server-side API calls. Fully mobile-responsive. |
| Hosting | Vercel | Seamless deployment and CI/CD for Next.js. |
| Mobile Strategy | PWA (Progressive Web App) | Allows "Add to Home Screen" for fast, native-like access on iOS/Android. |
...
- **Learned Style Rules** (A dynamic list of rules auto-generated over time as the app learns from your edits — easily editable by you).
- **Golden Hooks Library** (A collection of your best-performing or favorite hooks. The AI references this to match the pacing and style of your proven winners).
...
#### Mode D — URL / Inspiration Parser
- Input field to paste an article, tweet, or newsletter URL.
- App automatically scrapes and summarizes the source content in the background.
- Routes to the Interview Engine with a dynamic prompt. The AI does *not* force a rigid "contrarian" or "African" angle here. Instead, it asks open-ended questions like: *"What stood out to you about this?"*, *"Do you agree with their premise?"*, or *"How does this apply to your specific experience?"* The goal is to dynamically extract *your* unique perspective, whatever it may be.
...
- **Continuous Learning Feedback Loop:** When you edit a generated draft and save it, the app silently sends the original AI draft and your edited version to Claude. Claude analyzes the "delta" (what you changed), extracts a new style rule (e.g., "User prefers shorter opening sentences" or "User never uses emojis"), and saves it to your **Learned Style Rules** in Module 1 for all future prompts.
...
| Capture (Voice / Video / Text / URL) | 2 | Build second |
...
- [ ] Module 2: Capture (all four modes)
- [ ] Module 3: Interview Engine
- [ ] Module 4: Content Generation Engine
- [ ] Module 5: Build Launch Campaign Generator
